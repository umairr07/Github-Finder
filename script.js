        ...
        try {
            async function fetchApi() {
                ...
                <div class="main-container mt-10 bg-gray-200 p-5 rounded-lg">
                    <div class="flex">
                    <img src="${data.avatar_url}" alt="" class="h-28 rounded-full" />
                    ...
                    <div class="mt-10 mb-10">
                        <div >
                            ...
                            <p class="pt-2">${data.location}</p>
                            <i class="fab fa-fw fa-twitter"></i>
                            <p class="pt-2">${data.twitter_username}</p>
                        
                        </div>
                        <div class="">
                            <i class="fas fa-fw fa-link"></i>
                            <p class="pt-2">${data.blog}</p>
                            <i class="fas fa-fw fa-building"></i>
                            <p class="pt-2">${data.company}</p>
